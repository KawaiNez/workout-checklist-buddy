  ...
  return (
    <div className="max-w-4xl mx-auto text-center">
      <div className="mb-8 sm:mb-12 px-4">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent">
          Fitness Tracker
        </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-2xl mx-auto px-4">
        <div
          ...
          className="group cursor-pointer bg-gradient-to-br from-orange-500 to-pink-600 rounded-2xl p-6 sm:p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
        >
        ...
        <div
          ...
          className="group cursor-pointer bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-6 sm:p-8 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
        >
          <div className="bg-white/20 rounded-full w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center mx-auto mb-4 sm:mb-6 group-hover:bg-white/30 transition-colors">
